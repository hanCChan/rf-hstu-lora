...
A natural next step is receiver-adaptive LoRa RFFI with calibration methods that do not require target-receiver labels, together with open-set authentication and lightweight compression for edge gateways.
