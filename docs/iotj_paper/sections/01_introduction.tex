...
\end{adjustbox}
\caption{Gateway-side LoRa device authentication under deployment shifts. The gateway captures IQ and spectral/OOB views from enrolled or suspicious transmitters and performs file-level RF fingerprint authentication.}
