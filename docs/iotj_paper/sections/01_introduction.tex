...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{figures/fig1_application_scenario.pdf}
\caption{Gateway-side LoRa device authentication under deployment shifts. The gateway captures IQ and spectral/OOB views and performs file-level RF fingerprint authentication.}
